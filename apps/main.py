...
# G = graph_tfidf.graph_ave_tfidf(materials, technical_term)

G = graph_embedding.graph_openai_embedding(materials)
...
# start_text_id = "75"
# end_text_id = "135"
# path, weight = find_max_weight_path(G, start_text_id, end_text_id)
